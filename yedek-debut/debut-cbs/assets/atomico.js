...
window.atomico = { ELEMENT_IGNORE_ATTR, ELEMENT_PROPS, customElement, h, html, render, toVnode, useCallback, useDelegateFocus, useEffect, useEvent, useHost, useMemo, useProp, useReducer, useRef, useState, useStyleSheet };
